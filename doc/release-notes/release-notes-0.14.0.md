...
now ZMQ can be used on Windows. Please see [this document](https://github.com/rivxcoin/rivxcoin/blob/master/doc/zmq.md) for
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/rivxcoin/rivxcoin/pull/8753)
...
- #7562 `1eef038` Bump transaction version default to 2 (rivxdrak)
...
- #8608 `7e9ab95` Install manpages via make install, also add some autogenerated manpages (nomnomrivx)
...
- #8568 `078900d` new var `DIST_CONTRIB` adds useful things for packagers from contrib (nomnomrivx)
...
- #9206 `e662d28` Make test constant consistent with consensus.h (rivxdrak)
