...
const std::string strMessageMagic = "Rivxcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s RIVX additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    } else if (nHeight == 1)                            { nSubsidy = 156000 * COIN; //premimed
    } else if (nHeight > 1 && nHeight <= 500)            { nSubsidy = 1 * COIN;
    } else if (nHeight > 500 && nHeight <= 10000)        { nSubsidy = 3 * COIN;
