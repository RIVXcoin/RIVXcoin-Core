...
git clone https://github.com/rivxcoin/rivxcoin
...
Output from `gbuild` will look something like
    ...
    From https://github.com/rivxcoin/rivxcoin
...
RIVXPATH=/some/root/path/bitcoin
SIGPATH=/some/root/path/bitcoin-detached-sigs

./bin/gbuild --url bitcoin=${RIVXPATH},signature=${SIGPATH} ../bitcoin/contrib/gitian-descriptors/gitian-win-signer.yml
```
