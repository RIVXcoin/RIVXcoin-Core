...
To receive security and update notifications, please subscribe to:
  ...
  <https://rivxcoin.com/en/list/announcements/join/>
...
randomly crashing on Windows XP. It is [not clear](https://github.com/rivxcoin/rivxcoin/issues/7681#issuecomment-217439891)
...
[Pull request](https://github.com/rivxcoin/rivxcoin/pull/8035/files), [BIP 32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/rivxcoin/rivxcoin/pull/7762).
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use RIVX/kB (MarcoFalke)
...
- #7692 `29b2be6` Remove P2P alert system (rivxdrak)
...
- #8275 `042c323` Remove bad chain alert partition check (rivxdrak)
...
- #7619 `18b3f1b` Add missing sudo entry in gitian VM setup (rivxdrak)
- #7616 `639ec58`  [depends] Delete unused patches  (MarcoFalke)
- #7658 `c15eb28` Add curl to Gitian setup instructions (rivxdrak)
...
- #7531 `18cb2d5` Add bip68-sequence.py to extended rpc tests (rivxdrak)
...
- #7773 `7c80e72` Fix comments in tests (rivxdrak)
...
- #7540 `ff46dd4` Rename OP_NOP3 to OP_CHECKSEQUENCEVERIFY (rivxdrak)
