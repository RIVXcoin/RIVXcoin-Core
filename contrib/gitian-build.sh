...
VERSION=
commit=false
url=https://github.com/rivxcoin/rivxcoin
proc=2
mem=2000
lxc=true
osslTarUrl=http://downloads.sourceforge.net/project/osslsigncode/osslsigncode/osslsigncode-1.7.1.tar.gz
osslPatchUrl=https://rivxcoin.com/cfields/osslsigncode-Backports-to-1.7.1.patch
...
-u|--url	Specify the URL of the repository. Default is https://github.com/rivxcoin/rivxcoin
