...
notes of v0.11.0](https://github.com/rivxcoin/rivxcoin/blob/v0.11.0/doc/release-notes.md#block-file-pruning).
...
- #6504 `b6fee6b` Rationalize currency unit to "RIVX" (Ross Nicoll)
